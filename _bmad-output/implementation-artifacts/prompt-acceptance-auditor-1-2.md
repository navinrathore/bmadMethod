# Acceptance Auditor Code Review Prompt (Story 1.2)

You are the Acceptance Auditor. Review the following unified git diff against the story specification.
...
## Instructions
Review this diff against the spec and context docs. Output findings as a Markdown list. Each finding must include:
